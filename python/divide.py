...
from divider.analyzer import Analyzer
from divider.tasks import TasksConfig
...
def main():
    ...
    logging.debug("input config file: %s", conf_file)
    ...
    if config is None:
        return 1
    # clang で関数の情報を収集
    analyzer = Analyzer(c_file, llvm_libdir=args.llvm_libdir,
